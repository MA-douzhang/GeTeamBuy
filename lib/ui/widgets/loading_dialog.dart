...
class LoadingDialog extends StatelessWidget {
  ...
  LoadingDialog(
      {required String this.title,double titleSize = AppDimens.DIMENS_42,Color textColor = AppColors.COLOR_999999, double indicatorRadius = AppDimens.DIMENS_60});
                  ...
                  child: Column(
                    ...
                    children: [
                      CupertinoActivityIndicator(
                        animating: true,
                        radius: ScreenUtil().setHeight(indicatorRadius ?? 0),
                      ),
                      Padding(
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: ScreenUtil().setSp(titleSize ?? 0),
                            color: textColor),
                      )
                    ],
                  ),
