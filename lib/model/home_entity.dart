...
class HomeEntity {
	...
	HomeEntity.fromJson(Map<String, dynamic> json) {
		if (json['newGoodsList'] != null) {
			newGoodsList = [];(json['newGoodsList'] as List).forEach((v) { newGoodsList?.add(new GoodsEntity.fromJson(v)); });
		}
		if (json['couponList'] != null) {
			couponList = [];(json['couponList'] as List).forEach((v) { couponList?.add(new HomeModelCouponlist.fromJson(v)); });
		}
		if (json['channel'] != null) {
			channel = [];(json['channel'] as List).forEach((v) { channel?.add(new HomeModelChannel.fromJson(v)); });
		}
		if (json['grouponList'] != null) {
			grouponList = [];(json['grouponList'] as List).forEach((v) { grouponList?.add(new HomeModelGrouponlist.fromJson(v)); });
		}
		if (json['banner'] != null) {
			banner = [];(json['banner'] as List).forEach((v) { banner?.add(new HomeModelBanner.fromJson(v)); });
		}
		if (json['brandList'] != null) {
			brandList = [];(json['brandList'] as List).forEach((v) { brandList?.add(new HomeModelBrandlist.fromJson(v)); });
		}
		if (json['hotGoodsList'] != null) {
			hotGoodsList = [];(json['hotGoodsList'] as List).forEach((v) { hotGoodsList?.add(new GoodsEntity.fromJson(v)); });
		}
		if (json['topicList'] != null) {
			topicList = [];(json['topicList'] as List).forEach((v) { topicList?.add(new HomeModelTopiclist.fromJson(v)); });
		}
		if (json['floorGoodsList'] != null) {
			floorGoodsList = [];(json['floorGoodsList'] as List).forEach((v) { floorGoodsList?.add(new HomeModelFloorgoodslist.fromJson(v)); });
		}
	}
...
class HomeModelFloorgoodslist {
	...
	HomeModelFloorgoodslist.fromJson(Map<String, dynamic> json) {
		...
		if (json['goodsList'] != null) {
			goodsList = [];(json['goodsList'] as List).forEach((v) { goodsList?.add(new GoodsEntity.fromJson(v)); });
		}
		id = json['id'];
	}
